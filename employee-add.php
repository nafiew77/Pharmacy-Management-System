...
<head>
  ...
  <!-- OVERRIDES: ensure the visible text is used, not a CSS ::before label -->
  <style>
    /* If nav2.css injects PHARMACIA via pseudo-elements, disable it */
    .sidenav h2::before,
    .sidenav h2::after,
    .sidenav::before { content: none !important; }

    /* Make sure our heading looks right */
    .sidenav h2{
...
<body>
  ...
  <div class="one row">
    <?php
      ...
      if(isset($_POST['add'])) {
        ...
        if(mysqli_query($conn, $sql)){
          echo "<p style='font-size:14px;'>Employee successfully added!</p>";
        } else{
    ...
    <form action="<?= $_SERVER['PHP_SELF'] ?>" method="post">
      <div class="column">
        <p><label for="eid">Employee ID:</label><br><input type="number" name="eid" id="eid"></p>
        <p><label for="efname">First Name:</label><br><input type="text" name="efname" id="efname"></p>
        <p><label for="elname">Last Name:</label><br><input type="text" name="elname" id="elname"></p>
        <p><label for="ebdate">Date of Birth:</label><br><input type="date" name="ebdate" id="ebdate"></p>
        <p><label for="eage">Age:</label><br><input type="number" name="eage" id="eage"></p>
        <p>
      ...
      <div class="column">
        ...
        <p><label for="ejdate">Date of Joining:</label><br><input type="date" name="ejdate" id="ejdate"></p>
        <p><label for="esal">Salary:</label><br><input type="number" step="0.01" name="esal" id="esal"></p>
        <p><label for="ephno">Phone Number:</label><br><input type="number" name="ephno" id="ephno"></p>
        <p><label for="e_mail">Email ID:</label><br><input type="email" name="e_mail" id="e_mail"></p>
        <p><label for="eadd">Address:</label><br><input type="text" name="eadd" id="eadd"></p>
      </div>
